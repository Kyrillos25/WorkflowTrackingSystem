...
namespace WorkflowTracking.Modules.WFProcessor.Infrastructure.Outbox;
...
{
    private const string ModuleName = "processors";
        ...
        IDbTransaction transaction)
    {
        string sql =
            $"""
             ...
             FROM processors.outbox_messages
        ...
        Exception? exception)
    {
        const string sql =
            """
            UPDATE processors.outbox_messages
